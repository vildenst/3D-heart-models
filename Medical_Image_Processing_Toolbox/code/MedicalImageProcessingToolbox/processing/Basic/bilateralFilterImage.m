function out = bilateralFilterImage(im,varargin)
% out = bilateralFilterImage(im)
% out = bilateralFilterImage(im'interpolation',interp)
%
% Bilateral filter of an image using the method from
% TOMASI, Carlo; MANDUCHI, Roberto. Bilateral filtering for gray 
% and color images. En Computer Vision, 1998. Sixth International 
% Conference on. IEEE, 1998. p. 839-846.
%
